...
class StreamlitApp:
    ...
    def create_plots(self):
        ...
        quick_recipe_fig = recipe_interaction_plot.plot_rate_easy_recipes_per_year()

        return recipe_fig, interaction_fig, quick_recipe_fig
    ...
    def run(self):
        ...
        recipe_fig, interaction_fig, quick_recipe_fig = self.create_plots()
        ...
        st.plotly_chart(quick_recipe_fig)