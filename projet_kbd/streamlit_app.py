...
def run(path_file , recipe_file , interaction_file , engine):
        ...
        with st.sidebar:
            selected = option_menu("Dashboard", ["Presentation", 'Nutrition Analysis', 'Cuisine Analysis', 'Sociological Insight', 'Free Visualisation']
                , menu_icon="cast")
        ...
        if selected == 'Presentation':
            ...
            recipe_fig, interaction_fig = create_plots(analyzer)  # Fonction qui génère les figures Plotly
            ...
            with col[0]:
                st.plotly_chart(quick_recipe_fig, use_container_width=True, caption="Proportion of Quick Recipes (2002-2010)")

            with col[1]:
                st.plotly_chart(interactions_quick_recipe_fig, use_container_width=True, caption="Rate of Interactions for Quick Recipes (2002-2010)")
            ...
            categories_quick_recipe_fig = create_categories_quick_recipe_chart(analyzer, engine)
            st.plotly_chart(categories_quick_recipe_fig, use_container_width=True, caption="Distribution of Quick Recipe Categories (2002-2010)")
            st.write("""
